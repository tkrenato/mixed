...
def encrypt_symmetric(project_id, location_id, key_id, key_ring_id, plaintext):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('key_id', help='Key name')
    parser.add_argument('key_ring_id', help='Key Ring name')
    parser.add_argument('plaintext', help='Text to be encrypted')
    args = parser.parse_args()

    encrypt_symmetric(args.project_id, args.location_id, args.key_id, args.key_ring_id, args.plaintext)
